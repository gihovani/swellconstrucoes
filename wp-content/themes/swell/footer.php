						...
						<?php if ($link1) : ?>
							<a class="button_outline flex-grow-1" href="<?php echo esc_url($link1); ?>" target="_BLANK">
								<div class="d-flex justify-content-center align-items-center">
									<?php if ($cfg_site_footer_btn_1_icon = get_field('cfg_site_footer_btn_1_icon', 'options')) : ?>
										<div class="cfg_site_footer_btn_1_icon">
											<?php echo $cfg_site_footer_btn_1_icon; ?>
										</div>
									<?php endif; ?>
									<div class="d-flex flex-column">
										<?php if ($cfg_site_footer_btn_1_text_1 = get_field('cfg_site_footer_btn_1_text_1', 'options')) : ?>
											<div class="cfg_site_footer_btn_1_text_1">
												<?php echo $cfg_site_footer_btn_1_text_1; ?>
											</div>
										<?php endif; ?>
										<?php if ($cfg_site_footer_btn_1_text_2 = get_field('cfg_site_footer_btn_1_text_2', 'options')) : ?>
					...
					<div class="col-12 col-lg-4 my-2 d-flex">
						<?php if ($link2) : ?>
							<a class="button_outline flex-grow-1" href="<?php echo esc_url($link2); ?>" target="_BLANK">
								<div class="d-flex justify-content-center align-items-center">
									<?php if ($cfg_site_footer_btn_2_icon = get_field('cfg_site_footer_btn_2_icon', 'options')) : ?>
										<div class="cfg_site_footer_btn_2_icon">
											<?php echo $cfg_site_footer_btn_2_icon; ?>
										</div>
                                    <?php endif; ?>
									<div class="d-flex flex-column">
										<?php if ($cfg_site_footer_btn_2_text_1 = get_field('cfg_site_footer_btn_2_text_1', 'options')) : ?>
											<div class="cfg_site_footer_btn_2_text_1">
												<?php echo $cfg_site_footer_btn_2_text_1; ?>
											</div>
                                        <?php endif; ?>
										<?php if ($cfg_site_footer_btn_2_text_2 = get_field('cfg_site_footer_btn_2_text_2', 'options')) : ?>
					...
					<div class="col-12 col-lg-4 my-2 d-flex">
						<?php if ($link3) : ?>
							<a class="button_outline flex-grow-1" href="<?php echo esc_url($link3); ?>" target="_BLANK">
								<div class="d-flex justify-content-center align-items-center">
									<?php if ($cfg_site_footer_btn_3_icon = get_field('cfg_site_footer_btn_3_icon', 'options')) : ?>
										<div class="cfg_site_footer_btn_3_icon">
											<?php echo $cfg_site_footer_btn_3_icon; ?>
										</div>
									<?php endif; ?>
									<div class="d-flex flex-column">
										<?php if ($cfg_site_footer_btn_3_text_1 = get_field('cfg_site_footer_btn_3_text_1', 'options')) : ?>
											<div class="cfg_site_footer_btn_3_text_1">
												<?php echo $cfg_site_footer_btn_3_text_1; ?>
											</div>
										<?php endif; ?>
										<?php if ($cfg_site_footer_btn_3_text_2 = get_field('cfg_site_footer_btn_3_text_2', 'options')) : ?>
		...
		<div class="container">
			<div class="row py-3">
				<div class="col-12 d-flex align-items-center justify-content-center flex-wrap">
					...
					<?php if (have_rows('cfg_site_footer_selos_rep', 'options')) : ?>
						<div class="footer_selos">
							<?php while (have_rows('cfg_site_footer_selos_rep', 'options')) : the_row(); ?>
								<img src="<?php echo get_sub_field('cfg_site_footer_selos_rep_item_img')['sizes']['thumbnail'] ?>" alt="selos" class="m-3">
							<?php endwhile; ?>
						</div>
					<?php endif; ?>
                </div>
            ...
            <div class="row py-2">
                <div class="col-12 d-flex align-items-center justify-content-center flex-wrap">
					<?php wp_nav_menu(['menu' => 'Footer Redes Sociais', 'container' => false]); ?>
				</div>
			</div>
		</div>
	</section>
